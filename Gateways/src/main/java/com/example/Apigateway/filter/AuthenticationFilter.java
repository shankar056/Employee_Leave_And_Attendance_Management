...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
	...
	private boolean isAuthorized(String role, String path, String method) {
		if ("MANAGER".equalsIgnoreCase(role)) {
			return path.startsWith("/employees") || path.startsWith("/leaverequest") || path.startsWith("/leavebalance")
					|| path.startsWith("/attendance") || path.startsWith("/shifts") || path.startsWith("/report");
			...
			return path.startsWith("/attendance/clockin") || path.startsWith("/attendance/clockout")
					...
					|| path.startsWith("/leavebalance")|| path.startsWith("/employees")|| path.startsWith("/leaverequest")|| path.startsWith("/report");
		} else if ("EMPLOYEE".equalsIgnoreCase(role)) {;
		}
		return false;
	}	
